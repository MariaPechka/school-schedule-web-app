...
lessons = sch_models.Lesson.objects.all().annotate(
    class_name = Concat('class_m__eduparallel__year', 
                        Value(' '),
                        'class_m__letter',
                        output_field=CharField()
    )
...
# Преобразуем данные, полученные из базы для ГА
...
# # Пробую ГА на функциях класса gcp
# POPULATION_SIZE = 100
# P_CROSSOVER = 0.9
# P_MUTATION = 0.1
# MAX_GENERATIONS = 100
